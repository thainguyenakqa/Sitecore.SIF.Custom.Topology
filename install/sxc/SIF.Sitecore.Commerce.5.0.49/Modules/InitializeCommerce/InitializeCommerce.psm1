Function Invoke-UpdateRedisConnectionTask {
    ...
    $node = $xml.configuration.sitecore.commerceCachingConfiguration.cachingSettings.redis.options
    $node.configuration = $node.configuration -replace "localhost", "$RedisConnection"
...
Function Invoke-UpdateHostnamesTask {
    ...
    $node.shopsServiceUrl = $node.shopsServiceUrl -replace "https://localhost:5000", "$ShopsUrl"
    $node.commerceOpsServiceUrl = $node.commerceOpsServiceUrl -replace "https://localhost:5000", "$OpsUrl"
    $node.commerceMinionsServiceUrl = $node.commerceMinionsServiceUrl -replace "https://localhost:5000", "$MinionsUrl"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUL1U04qcPnIhiDZJNow/YTce5
# bRagghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFRndt1ZGVqUurtFtwPCjqYn
# JSuXMA0GCSqGSIb3DQEBAQUABIIBALSYZb4hUh+PyvyvsiTy9YbD9xs5iyF84nqq
# bAd3A1wnI6IC5ZqziQngs8bbIVB/xHDUIdoTEPjXouLkFKM+bHJoztTeOCtyuRPj
# Rx+tA8JMR6dG0lgVGVkLGsQxHQ9I8fcQSg7+Y/s2wpCU+1efbt2x95YZMTy+3wVJ
# 5TGbx36v+l39eM+earjB72PcY3BjI/EID6zW6eT6kMZz3GTKoDrvkxLMGrLa+0oy
# NaaOk2S+Jv3/mxIUxxgtARFJ1X2xGega7OmHQGUilMgoXX1k7F8Rn3CeclaMkPGW
# Q7KRE3RhvmhJGo/G/6J+rNQCPO9jD9WfxnazJZ2XMuqLjjaUQr6hggILMIICBwYJ
...
# MjAwNzI5MTQzMjI5WjAjBgkqhkiG9w0BCQQxFgQUyprUNUALLu4p+f9+FlelwLHq
# jyMwDQYJKoZIhvcNAQEBBQAEggEAjLvcdZ1+o21R9otR1nprmlMk20r3qF9QBKHg
# vW08MkIdNXh+U9snuuAk9QMbe8VFc60YF6f7U28mJ5RHUZ+wYCFP9Yufg9ePOqQl
# WvA/nkKN8mOwagwG4PLf6XqYw5vqbvY5KtC0UdIuS1N33vvzBjxlm/THAApgnnj7
# IwhNeOk7dRAoYj206uCSWc3L1z6pd76cymxirWNIDY0i+UoY6m4SE9BHHd4NpXpL
# guKR/badWwgjPLEzVvccJoLbQ8Is97YNaMqGm0bRGRISgjAZ83NPs2FqbbAo9cIE
# U6r1hsObAH8qfHixAUYx9gZtN1E7dKemzEgRIhdFq9+s1fbE5g==
