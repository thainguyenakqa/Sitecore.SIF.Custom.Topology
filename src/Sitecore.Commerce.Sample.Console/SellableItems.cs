    ...
    public static class SellableItems
    {
        ...
        public static void RunScenarios()
        {
            using (new SampleScenarioScope("SellableItems"))
            {
                ...
                GetSellableItem_DynamicBundle();
                GetBulkPrices();
                DynamicBundle_GetSelectedAutomaticPrice();
        ...
        private static void DynamicBundle_GetSelectedAutomaticPrice()
        {
            ...
            {
                new BundleItem(){ SellableItemId = "Habitat_Master|7042078|57042078", Quantity = 2},
                new BundleItem(){ SellableItemId = "Habitat_Master|6042063|", Quantity = 3},
            };
