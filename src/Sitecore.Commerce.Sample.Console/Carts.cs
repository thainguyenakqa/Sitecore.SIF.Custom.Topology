    ...
    public static class Carts
    {
        ...
        public static void RunScenarios()
        {
            using (new SampleScenarioScope("Carts"))
            {
                ...
                AddToCart_GetCart_DynamicBundle();
        ...
        public static void GetCart_DoNotCalculate_EnsureCartProperties()
        {
            using (new SampleMethodScope())
            {
                ...
                cart.DateCreated.Should().BeCloseTo(cart2.DateCreated.Value, 10000);
                cart.DateUpdated.Should().BeCloseTo(cart2.DateUpdated.Value, 10000);
                ...
                lineItem.UnitListPrice.Amount.Should().Be(lineItem2.UnitListPrice.Amount);
                lineItem.UnitListPrice.CurrencyCode.Should().Be(lineItem2.UnitListPrice.CurrencyCode);
        ...
        public static void AddToCart_GetCart_ProductAndBundle()
        {
            using (new SampleMethodScope())
            {
                ...
                var cartId = GenerateCartId();
                var command = Proxy.DoCommand(HabitatShopsContainer.AddCartLine(cartId, cameraId, 1, UpdatedCartExpands));
        ...
        public static void AddToCart_GetCart_DynamicBundle()
        {
            using (new SampleMethodScope())
            {
                var cameraId = "Habitat_Master|7042124|57042124";
                var dynamicBundleId = "Habitat_Master|6002002|";
                var subLine1 = "Habitat_Master|6042063|56042063";
                var subLine2 = "Habitat_Master|7042078|57042078";
                ...
                var actionQuery = HabitatShopsContainer.AddCartLineWithSubLines(
                    ...
                    new List<CartSubLine>()
                    {
                        new CartSubLine()
                        {
                            ItemId = subLine1, Quantity = 2
                        },
                        new CartSubLine()
                        {
                            ItemId = subLine2, Quantity = 2
                        }
                    },
                    UpdatedCartExpands);
        ...
        {
            Proxy.DoCommand(AwShopsContainer.DeleteCart(cartId));
        }
